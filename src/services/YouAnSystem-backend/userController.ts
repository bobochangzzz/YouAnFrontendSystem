...
/** exportUserData GET /api/user/export */
export async function exportUserDataUsingGET(options?: { [key: string]: any }) {
  return request<API.BaseResponseboolean>('/api/user/export', {
    method: 'GET',
    ...(options || {}),
  });
}
...
export async function getUserByIdUsingGET(
  ...
  return request<API.BaseResponseCurrentUserVO>('/api/user/get', {
    method: 'GET',
    params: {
      ...params,
    },
...
/** importUserData POST /api/user/import */
export async function importUserDataUsingPOST(body: string, options?: { [key: string]: any }) {
